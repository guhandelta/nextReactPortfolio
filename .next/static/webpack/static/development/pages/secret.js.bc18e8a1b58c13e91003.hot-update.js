...
function (_React$Component) {
  ...
  function Secret(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Secret).call(this));
    _this.state = {
      secretData: []
    };
    return _this;
  ...
  _createClass(Secret, [{
    ...
    value: function displaySecretData() {
      var secretData = this.prosp.secretData;
...
//# sourceMappingURL=secret.js.bc18e8a1b58c13e91003.hot-update.js.map