...
var getCookieFromReq = function getCookieFromReq(req, cookie) {
  var tokenCookie = req.headers.cookie.split(';').find(function (c) {
    return c.trim().startsWith("".concat(ccookie, "="));
  });
...
//# sourceMappingURL=secret.js.1d29836c39717ad25be0.hot-update.js.map