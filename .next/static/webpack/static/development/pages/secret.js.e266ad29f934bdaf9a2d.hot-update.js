...
function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://localhost:4000/api/v1/secret/', setAuthHeader()).then(function (response) {
              return response.data;
            });
  ...
  return function getSecretDataServer() {
...
//# sourceMappingURL=secret.js.e266ad29f934bdaf9a2d.hot-update.js.map